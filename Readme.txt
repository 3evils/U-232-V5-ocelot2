...
|--------------------------------------------------------------------|
	...
	Use the following commands to install some of the C++ dependencies on CentOS, Fedora Core and Red Hat. The g++ version should be at least 4.7.
		...
		UPDATE ME yum install boost-devel gcc-c++ mysql-devel subversion
