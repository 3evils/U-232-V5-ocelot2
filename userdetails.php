...
if ($CURUSER['class'] >= UC_STAFF && OCELOT_TRACKER == false) $HTMLOUT.= "<div class='col-sm-1'>{$lang['userdetails_freeleech_slots']}</div><div class='col-sm-1'><input class='form-control' type='text' name='freeslots' value='" . (int)$user['freeslots'] . "'></div>";
